<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      ...
      <!-- Tutorials Grid -->
      <div v-else-if="tutorials.length > 0" class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div 
          v-for="tutorial in tutorials" 
          :key="tutorial.slug"
          class="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md transition-shadow cursor-pointer"
          @click="viewTutorial(tutorial.slug)"
        >
          ...
          <!-- Tags -->
          <div v-if="tutorial.tags && tutorial.tags.length > 0" class="mb-4">
          ...
          <div class="flex items-center justify-between">
            <span class="text-xs text-gray-500">By {{ tutorial.author }}</span>
...
const BASE_ROUTE = '/tutorials'

// Page content constants
const PAGE_TITLE = 'Tutorials'
const LOADING_TEXT = 'Loading tutorials...'
const NO_CONTENT_TITLE = 'No Tutorials Yet'
const NO_CONTENT_MESSAGE = "We're working on some amazing tutorials. Check back soon!"
const READ_ACTION_TEXT = 'Read Tutorial →'
